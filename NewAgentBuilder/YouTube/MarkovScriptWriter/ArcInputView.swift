...
//  NewAgentBuilder
//
//  Extracted from MarkovScriptWriterView — displays the raw rambling input,
//  autoload banner, gist summary, and gist list.
//  Used by ArcScriptWriterView as the Input tab.
//

import SwiftUI

struct ArcInputView: View {
